...
Require this package in your composer.json and update composer. This will download the package and the dompdf + fontlib libraries also.
    ...
    composer require kiritodeveloper/laravel-dompdf
...
After updating composer, add the ServiceProvider to the providers array in config/app.php
    ...
    kiritodeveloper\DomPDF\ServiceProvider::class,

You can optionally use the facade for shorter code. Add this to your facades:

    'PDF' => kiritodeveloper\DomPDF\Facade::class,
...
After updating composer add the following lines to register provider in `bootstrap/app.php`
  ...
  ```
  $app->register(\kiritodeveloper\DomPDF\ServiceProvider::class);
  ```
...
The defaults configuration settings are set in `config/dompdf.php`. Copy this file to your own config directory to modify the values. You can publish the config using this command:
    ...
    php artisan vendor:publish --provider="kiritodeveloper\DomPDF\ServiceProvider"
